...
// *********************************************************
//
// This function counts the number of nodes in the linked
// list and return its result as an int.
//
// *********************************************************
int CapitalList::countNodes(ListNode *nodePtr) const
{
    if (nodePtr != nullptr)
...
// *********************************************************
//
// This function goes through the list and finds the largest
// value. It return the largest value as a char.
// (NOTE: Z has a higher value than A)
//
// *********************************************************
char CapitalList::largestNode(ListNode *nodePtr, char max) const
{
    if(nodePtr == nullptr)
        return max;
    if(nodePtr->cap > max)
    ...
    return largestNode(nodePtr->next, max);
}
